            ...
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center h-16 lg:h-20">
                <Link href="/" className="flex items-center gap-2">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-[#2563eb] to-[#7c3aed] rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20">
                  ...
                  <span className="text-base sm:text-lg font-bold tracking-tight">
                    ...
                    <span className="text-[#2563eb] hidden min-[400px]:inline">.software</span>
                  </span>
                </Link>

                {/* Desktop nav */}
                <div className="hidden md:flex items-center gap-8">
                  <a href="#programa" className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-[#2563eb] dark:hover:text-[#2563eb] transition-colors">Programa</a>
                  <a href="#metodologia" className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-[#2563eb] dark:hover:text-[#2563eb] transition-colors">Metodología</a>
                  <a href="#aplicar" className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-[#2563eb] dark:hover:text-[#2563eb] transition-colors">Aplicar</a>
                </div>
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <a
                    href="#aplicar"
                    className="hidden sm:flex btn-gradient btn-shine text-white px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg sm:rounded-xl text-xs sm:text-sm font-bold items-center gap-1"
                  >
                    Aplicar
                  </a>
              ...
              {mobileMenuOpen && (
                <div className="md:hidden py-4 border-t border-slate-200 dark:border-white/10">
                  <div className="flex flex-col gap-2">
                    <a href="#programa" onClick={() => setMobileMenuOpen(false)} className="py-2 text-slate-600 dark:text-slate-400 hover:text-[#2563eb]">Programa</a>
                    <a href="#metodologia" onClick={() => setMobileMenuOpen(false)} className="py-2 text-slate-600 dark:text-slate-400 hover:text-[#2563eb]">Metodología</a>
                    <a href="#aplicar" onClick={() => setMobileMenuOpen(false)} className="py-2 text-slate-600 dark:text-slate-400 hover:text-[#2563eb]">Aplicar</a>
                  </div>
                </div>
              )}
            </nav>
          ...
          <main>
            ...
            <section className="relative pt-16 lg:pt-24 pb-20 lg:pb-32 px-4 sm:px-6 lg:px-8">
              <div className="max-w-5xl mx-auto text-center">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#2563eb]/10 border border-[#2563eb]/20 mb-8 reveal-text">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12 reveal-text delay-3">
                  <a
                    href="#aplicar"
                    className="btn-gradient btn-shine text-white px-8 py-4 rounded-2xl text-lg font-bold flex items-center justify-center gap-2"
                  >
                    Aplicar ahora
                  ...
                  <a
                    href="#programa"
                    className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-[#2563eb]/50 text-slate-900 dark:text-white px-8 py-4 rounded-2xl text-lg font-bold transition-all flex items-center justify-center gap-2"
                  >
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                  {[
                    ...
                    <div key={i} className="bento-card rounded-2xl p-6 lg:p-8 text-center">
                      <span className="material-symbols-outlined text-[#2563eb] text-3xl mb-3">{stat.icon}</span>
            ...
            <section id="metodologia" className="py-20 lg:py-32 px-4 sm:px-6 lg:px-8">
              <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-12 lg:mb-16">
                  <span className="text-[#2563eb] font-bold text-sm tracking-widest uppercase block mb-3">
                    Metodología Bento
                  </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 lg:gap-6">
                  ...
                  <div className="md:col-span-2 md:row-span-2 bento-card rounded-3xl p-8 lg:p-10 relative overflow-hidden group min-h-[400px] flex flex-col justify-between">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#2563eb]/5 to-[#7c3aed]/5 dark:from-[#2563eb]/10 dark:to-[#7c3aed]/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    <div className="relative z-10">
                      <div className="w-14 h-14 rounded-2xl bg-[#2563eb]/10 border border-[#2563eb]/20 flex items-center justify-center text-[#2563eb] mb-6">
                  ...
                  <div className="md:col-span-2 bento-card rounded-3xl p-8 flex items-center justify-between gap-6">
                    ...
                    <div className="w-20 h-20 lg:w-24 lg:h-24 rounded-full border-4 border-[#2563eb]/20 flex items-center justify-center bg-[#2563eb]/5 flex-shrink-0">
                      <span className="material-symbols-outlined text-[#2563eb] text-3xl lg:text-4xl">videocam</span>
                    </div>
                  </div>
                  ...
                  {/* Small card 2 */}
                  <div className="bento-card rounded-3xl p-6 flex flex-col justify-center items-center text-center">
                    <span className="material-symbols-outlined text-4xl text-[#7c3aed] mb-3">support_agent</span>
                ...
                <div className="pricing-card p-8 lg:p-12 glow-primary">
                  <div className="flex flex-col lg:flex-row gap-12 items-center">
                    <div className="flex-1 text-center lg:text-left">
                      <div className="inline-block px-4 py-1.5 rounded-full bg-[#2563eb]/10 text-[#2563eb] text-xs font-black uppercase tracking-widest mb-6">
            ...
            <section className="py-20 lg:py-32 px-4 sm:px-6 lg:px-8">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <a
                  href="#precio"
                  className="btn-gradient btn-shine inline-flex items-center gap-2 text-white px-10 py-5 rounded-2xl text-lg font-bold"
                >
            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold">aprende<span className="text-[#2563eb]">.software</span></span>
                </div>

                <div className="flex gap-8 text-sm text-slate-500 dark:text-slate-400">
                  <Link href="/privacidad" className="hover:text-[#2563eb] transition-colors">Privacidad</Link>
                  <Link href="/" className="hover:text-[#2563eb] transition-colors">Curso gratuito</Link>
                  <a href="https://twitter.com/josusanz" target="_blank" rel="noopener noreferrer" className="hover:text-[#2563eb] transition-colors">Twitter</a>
                </div>

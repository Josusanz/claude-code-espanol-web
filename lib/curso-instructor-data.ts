...
export const GUIAS_INSTRUCTOR: GuiaInstructor[] = [
  {
    ...
    agenda: [
      ...
      },
      {
        ...
        titulo: 'Bienvenida',
        detalles: [
          'DI: "Bienvenidos al curso. Durante 10 semanas vamos a crear un SaaS completo — desde cero hasta tener usuarios reales pagando."',
          'DI: "No necesitáis saber programar: vais a usar Claude Code, que es la IA que escribe el código por vosotros. Vosotros ponéis la visión, Claude pone el código."',
          'DI: "El curso funciona así: cada semana tenéis una pre-clase (teoría que leéis antes), dos días de clase en vivo donde construimos juntos, y un entregable que subís al Discord."',
          'DI: "Lo más importante: vais a terminar con algo REAL publicado en internet. No es un curso teórico."',
        ],
      },
      {
        tiempo: '0:10-0:25',
        ...
        detalles: [
          'DI: "Vamos a presentarnos. Cada uno tiene 2 minutos. Quiero saber 4 cosas:"',
          ...
          'DESPUÉS DI: "Perfecto. Ya veis que hay ideas muy diferentes — eso es bueno. Si alguien no tiene idea todavía, no pasa nada, lo trabajamos hoy."',
        ],
      },
      {
        tiempo: '0:25-0:40',
        ...
        detalles: [
          ...
          'DI: "Antes de meternos en el curso, quiero que evaluéis cómo estáis AHORA como personas. Crear un proyecto requiere energía, tiempo y claridad — y si hay áreas de tu vida que están flojas, es mejor saberlo."',
          'DI: "Esta rueda tiene 9 áreas: Salud, Familia, Amigos, Vínculos, Crecimiento, Diversión, Ambiente, Carrera y Economía. Puntúa cada una del 1 al 10. Sed honestos — esto es solo para vosotros."',
          '⏱ DARLES 5 MINUTOS para rellenar y guardar.',
          'Comparte la tuya primero (modelar vulnerabilidad).',
          'DESPUÉS DI: "¿Alguien quiere compartir qué área tiene más baja? No hace falta decir el número, solo el área."',
          'DI: "Esto es normal. Al final del curso rellenáis otra vez y comparáis."',
        ],
      },
      {
        tiempo: '0:40-0:50',
        ...
        detalles: [
          'DI: "Ahora pasad al segundo tab: 🎯 Creador. Esta evalúa 8 áreas para crear tu proyecto: Claridad de visión, Habilidades técnicas, Tiempo, Energía, Apoyo social, Finanzas, Mentalidad y Propósito."',
          'DI: "Rellenadla igual — del 1 al 10 cada área. Cuando terminéis, guardad."',
          '⏱ DARLES 4 MINUTOS.',
          'DESPUÉS DI: "Si vais al tab 📊 Estadísticas, veis vuestra puntuación global combinando las dos ruedas. Este número es vuestro punto de partida. En la semana 10 lo comparamos."',
      ...
      },
      {
        ...
        detalles: [
          'DI: "Ahora la parte más importante del día: definir QUÉ vais a construir."',
          'DI: "Si ya tenéis una idea clara, genial. Si no la tenéis o no estáis seguros, vamos a trabajarlo ahora con Claude."',
          'DI: "Abrid Claude.ai o Claude Code y copiad uno de los dos prompts que tenéis en la pizarra — paso 5."',
          ...
          'DESPUÉS: pide a 2-3 personas que compartan su idea y el feedback de Claude.',
          'DI: "No hace falta que sea perfecta. La vais a ir afinando durante el curso. Lo importante es tener un punto de partida."',
        ],
      },
      {
        tiempo: '1:05-1:15',
        ...
        detalles: [
          'DI: "Antes de hacer un descanso, quiero que compartamos algo: ¿qué os da miedo de este curso? ¿Qué creéis que os va a costar más?"',
          'DI: "Yo empiezo: [comparte algo tuyo genuino]."',
          ...
          'DESPUÉS DI: "Todo lo que habéis dicho es completamente normal. La clave es: no tenéis que saber programar. Claude lo hace. Vosotros solo tenéis que tener clara la visión — y eso ya lo hemos trabajado hoy."',
        ],
      },
      {
        tiempo: '1:15-1:25',
        titulo: 'DESCANSO',
        detalles: [
          'DI: "10 minutos de descanso. Estirad, bebed agua. Cuando volvamos hacemos el tour rápido de herramientas y cerramos."',
        ],
      },
      {
        tiempo: '1:25-1:40',
        ...
        detalles: [
          ...
          '1. /curso — DI: "Aquí veis las 10 semanas, vuestro progreso, y accedéis a las pre-clases y entregables."',
          '2. /curso/clase/1 — DI: "Esto es la pizarra. Cada clase tiene una con los pasos que seguimos en vivo. La estáis viendo ahora."',
          '3. /curso/themes — DI: "Mañana vais a elegir uno de estos themes como base para vuestra primera web. Echadles un ojo esta noche."',
          '4. Discord — DI: "El canal #dudas es para preguntas técnicas, #compartir para enseñar lo que hacéis. Preguntad sin miedo."',
        ],
      },
      {
        tiempo: '1:40-1:50',
        ...
        detalles: [
          'DI: "Para cerrar, quiero que cerréis los ojos un momento."',
          'DI: "Imaginad que han pasado 10 semanas. Vuestro proyecto está en producción, tenéis usuarios..."',
          'DI: "¿Cómo os sentís? ¿Qué habéis aprendido? ¿Quién sois ahora?"',
          'DI: "Escribid 3 palabras que describan ese futuro en el chat."',
      ...
      },
      {
        ...
        detalles: [
          'DI: "Para mañana necesito 3 cosas:"',
          ...
          'DI: "Si algo no funciona, preguntad en Discord esta noche y os ayudo. Mañana arrancamos directamente a construir."',
